...
var file_graphql_proto_extTypes = []protoimpl.ExtensionInfo{
	...
	},
	{
		...
		Field:         1055,
		Name:          "graphql.enabled",
		Tag:           "varint,1055,opt,name=enabled",
		Filename:      "graphql.proto",
	},
	{
...
var (
	// optional bool enabled = 1055;
	E_Enabled = &file_graphql_proto_extTypes[1]
)

// Extension fields to descriptor.ServiceOptions.
var (
	// optional string host = 1088;
	E_Host = &file_graphql_proto_extTypes[2]
)

// Extension fields to descriptor.EnumOptions.
var (
	// optional string enum_name = 1086;
	E_EnumName = &file_graphql_proto_extTypes[3]
)

// Extension fields to descriptor.FieldOptions.
var (
	// optional bool optional = 1096;
	E_Optional = &file_graphql_proto_extTypes[4]
)
...
var file_graphql_proto_rawDesc = []byte{
	...
	0x65, 0x3a, 0x37, 0x0a, 0x07, 0x65, 0x6e, 0x61, 0x62, 0x6c, 0x65, 0x64, 0x12, 0x1c, 0x2e, 0x67,
	0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62, 0x75, 0x66, 0x2e, 0x46,
	0x69, 0x6c, 0x65, 0x4f, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x18, 0x9f, 0x08, 0x20, 0x01, 0x28,
	0x08, 0x52, 0x07, 0x65, 0x6e, 0x61, 0x62, 0x6c, 0x65, 0x64, 0x3a, 0x34, 0x0a, 0x04, 0x68, 0x6f,
...
var file_graphql_proto_depIdxs = []int32{
	...
	2, // 1: graphql.enabled:extendee -> google.protobuf.FileOptions
	3, // 2: graphql.host:extendee -> google.protobuf.ServiceOptions
	4, // 3: graphql.enum_name:extendee -> google.protobuf.EnumOptions
	5, // 4: graphql.optional:extendee -> google.protobuf.FieldOptions
