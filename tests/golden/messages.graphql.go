...
// WithModuleBooksDialOptions sets dial options for lazy client creation for the Books service
func WithModuleBooksDialOptions(opts ...grpc.DialOption) CasesModuleOption {
	return func(m *CasesModule) {
		m.booksDialOpts = opts
	}
}
...
func (m *CasesModule) getBooksClient() BooksClient {
	if m.booksClient == nil {
		...
		m.booksClient = NewBooksClient(pg.GrpcConnection(host, m.booksDialOpts...))
	}
