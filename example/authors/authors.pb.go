...
var file_authors_proto_rawDesc = []byte{
	...
	0x72, 0x52, 0x07, 0x61, 0x75, 0x74, 0x68, 0x6f, 0x72, 0x73, 0x22, 0xa9, 0x01, 0x0a, 0x14, 0x41,
	...
	0x6e, 0x61, 0x6d, 0x65, 0x32, 0xfd, 0x01, 0x0a, 0x07, 0x41, 0x75, 0x74, 0x68, 0x6f, 0x72, 0x73,
	...
	0x12, 0x4e, 0x0a, 0x11, 0x61, 0x75, 0x74, 0x68, 0x6f, 0x72, 0x73, 0x43, 0x6f, 0x6e, 0x6e, 0x65,
	0x63, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x1a, 0x2e, 0x67, 0x72, 0x61, 0x70, 0x68, 0x71, 0x6c, 0x2e,
	0x43, 0x6f, 0x6e, 0x6e, 0x65, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73,
	0x74, 0x1a, 0x1b, 0x2e, 0x67, 0x72, 0x61, 0x70, 0x68, 0x71, 0x6c, 0x2e, 0x43, 0x6f, 0x6e, 0x6e,
...
var file_authors_proto_goTypes = []interface{}{
	...
	(*graphql.BatchRequest)(nil),       // 5: graphql.BatchRequest
	(*graphql.ConnectionRequest)(nil),  // 6: graphql.ConnectionRequest
	(*graphql.ConnectionResponse)(nil), // 7: graphql.ConnectionResponse
}
var file_authors_proto_depIdxs = []int32{
	3, // 0: authors.GetAuthorsResponse.authors:type_name -> authors.Author
	4, // 1: authors.AuthorsBatchResponse.results:type_name -> authors.AuthorsBatchResponse.ResultsEntry
	3, // 2: authors.AuthorsBatchResponse.ResultsEntry.value:type_name -> authors.Author
	0, // 3: authors.Authors.getAuthors:input_type -> authors.GetAuthorsRequest
	5, // 4: authors.Authors.loadAuthors:input_type -> graphql.BatchRequest
	6, // 5: authors.Authors.authorsConnection:input_type -> graphql.ConnectionRequest
	...
	7, // 8: authors.Authors.authorsConnection:output_type -> graphql.ConnectionResponse
